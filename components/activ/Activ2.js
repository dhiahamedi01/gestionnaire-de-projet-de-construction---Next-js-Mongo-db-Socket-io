    ...
    <div>
        <div className={styles.card}>
            <div className={styles.block}>
                ...
                <span className={styles.title}>Project name 2</span>
            ...
            <div className={styles.block2}>
                <span className={styles.localisation}>
                  <i className="fas fa-map-marker-alt"></i>&ensp;Jandouba , Tabarka
                </span>
                <span className={styles.date}>
                  <i className="far fa-calendar-check"></i>&ensp;1/11/2000
                </span>
            </div>
            {moyenne?(
